...
class FW_STORE_TYPE(IntEnum):
    ...
    FW_STORE_TYPE_NOT_USED_VALUE_12 = 13
    FW_STORE_TYPE_MAX = 14
...
class FW_PORT_RANGE_LIST(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pPorts", [], PFW_PORT_RANGE, size_is=lambda pkt: pkt.dwNumEntries
            )
        ),
    ]
...
class FW_ICMP_TYPE_CODE_LIST(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pEntries", [], PFW_ICMP_TYPE_CODE, size_is=lambda pkt: pkt.dwNumEntries
            )
        ),
    ]
...
class FW_IPV4_SUBNET_LIST(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pSubNets", [], PFW_IPV4_SUBNET, size_is=lambda pkt: pkt.dwNumEntries
            )
        ),
    ]
...
class FW_IPV6_SUBNET_LIST(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pSubNets", [], PFW_IPV6_SUBNET, size_is=lambda pkt: pkt.dwNumEntries
            )
        ),
    ]
...
class FW_OS_PLATFORM_LIST(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pPlatforms", [], PFW_OS_PLATFORM, size_is=lambda pkt: pkt.dwNumEntries
            )
        ),
    ]
...
class FW_RULE_ORIGIN_TYPE(IntEnum):
    ...
    FW_RULE_ORIGIN_MDM = 7
    FW_RULE_ORIGIN_MAX = 8
    FW_RULE_ORIGIN_HOST_LOCAL = 9
    FW_RULE_ORIGIN_HOST_GP = 10
    FW_RULE_ORIGIN_HOST_DYNAMIC = 11
    FW_RULE_ORIGIN_HOST_MDM = 12
    FW_RULE_ORIGIN_HOST_MAX = 13
...
class PFW_RULE2_0(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_0"))
            )
        ),
...
class PFW_CS_RULE2_0(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_CS_RULE2_0"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class u_sub0(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [NDRRefEmbPointerField(NDRConfVarStrNullFieldUtf16("wszCAName", ""))]


class u_sub1(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [NDRRefEmbPointerField(NDRConfVarStrNullFieldUtf16("wszSHKey", ""))]
...
class PFW_AUTH_SET2_10(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_AUTH_SET2_10"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pSuites", [], PFW_AUTH_SUITE2_10, size_is=lambda pkt: pkt.dwNumSuites
            )
        ),
        NDRInt3264EnumField("Origin", 0, FW_RULE_ORIGIN_TYPE),
        NDRFullEmbPointerField(
...
class PFW_CRYPTO_SET(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_CRYPTO_SET"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRInt3264EnumField("IpSecPhase", 0, FW_IPSEC_PHASE),
...
class PFW_PHASE1_SA_DETAILS(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRPacketField("pFirstAuth", PFW_AUTH_INFO(), PFW_AUTH_INFO)
        ),
        NDRFullEmbPointerField(
            NDRPacketField("pSecondAuth", PFW_AUTH_INFO(), PFW_AUTH_INFO)
        ),
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfFieldListField(
                "pRuleCategories",
                [],
                NDRIntEnumField("", 0, FW_RULE_CATEGORY),
                size_is=lambda pkt: pkt.dwNumRuleCategories,
            )
        ),
        NDRRefEmbPointerField(NDRConfVarStrNullFieldUtf16("pszDisplayName", "")),
        NDRFullEmbPointerField(
            NDRConfVarStrNullFieldUtf16("pszPathToSignedProductExe", "")
        ),
    ]
...
class FW_ENFORCEMENT_STATE(IntEnum):
    ...
    FW_ENFORCEMENT_STATE_DUPLICATE = 26
    FW_ENFORCEMENT_STATE_MAX = 27
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfFieldListField(
                "pEnforcementStates",
                [],
                NDRInt3264EnumField("", 0, FW_ENFORCEMENT_STATE),
                size_is=lambda pkt: pkt.dwNumEntries,
            )
        ),
    ]
...
class PFW_MM_RULE(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_MM_RULE"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class FW_MATCH_KEY(IntEnum):
    ...
    FW_MATCH_KEY_REMOTE_USER_AUTH_LIST = 16
    FW_MATCH_KEY_PACKAGE_FAMILY_NAME = 17
    FW_MATCH_KEY_MAX = 18
...
class PFW_RULE2_10(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_10"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class PFW_CS_RULE2_10(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_CS_RULE2_10"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class PFW_NETWORK(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [
        NDRFullEmbPointerField(NDRConfVarStrNullFieldUtf16("pszName", "")),
...
class PFW_ADAPTER(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [
        NDRFullEmbPointerField(NDRConfVarStrNullFieldUtf16("pszFriendlyName", "")),
...
class PFW_CS_RULE(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_CS_RULE"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class u_sub0(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [
        NDRRefEmbPointerField(NDRConfVarStrNullFieldUtf16("wszCAName", "")),
        NDRFullEmbPointerField(
...
class u_sub2(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [
        NDRFullEmbPointerField(NDRConfVarStrNullFieldUtf16("wszProxyServer", ""))
    ]
...
class PFW_AUTH_SET(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_AUTH_SET"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRInt3264EnumField("IpSecPhase", 0, FW_IPSEC_PHASE),
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField(
                "pSuites", [], PFW_AUTH_SUITE, size_is=lambda pkt: pkt.dwNumSuites
            )
        ),
        NDRInt3264EnumField("Origin", 0, FW_RULE_ORIGIN_TYPE),
        NDRFullEmbPointerField(
...
class PFW_RULE2_20(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_20"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class PFW_RULE2_24(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_24"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class PFW_RULE2_25(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_25"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class PFW_RULE2_26(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_26"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class PFW_RULE2_27(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_27"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class FW_DYNAMIC_KEYWORD_ADDRESS_ID_LIST(NDRPacket):
    ...
    fields_desc = [
        ...
        NDRFullEmbPointerField(
            NDRConfPacketListField("ids", [], GUID, size_is=lambda pkt: pkt.dwNumIds)
        ),
    ]


class PFW_RULE2_31(NDRPacket):
    ALIGNMENT = (4, 8)
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE2_31"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class RRPC_FWAddFirewallRule2_31_Request(NDRPacket):
    fields_desc = [
        NDRLongField("rpcConnHandle", 0),
        NDRPacketField("hPolicyStore", NDRContextHandle(), NDRContextHandle),
        NDRPacketField("pRule", PFW_RULE2_31(), PFW_RULE2_31),
    ]
...
class RRPC_FWEnumFirewallRules2_31_Response(NDRPacket):
    fields_desc = [
        NDRIntField("pdwNumRules", 0),
        NDRFullPointerField(NDRPacketField("ppRules", PFW_RULE2_31(), PFW_RULE2_31)),
        NDRIntField("status", 0),
    ]
...
class PFW_RULE(NDRPacket):
    ...
    fields_desc = [
        NDRFullEmbPointerField(
            NDRFullEmbPointerField(
                NDRPacketField("pNext", None, NDRRecursiveClass("PFW_RULE"))
            )
        ),
        NDRShortField("wSchemaVersion", 0),
        NDRRefEmbPointerField(
...
class RRPC_FWAddFirewallRule2_33_Request(NDRPacket):
    fields_desc = [
        NDRLongField("rpcConnHandle", 0),
        NDRPacketField("hPolicyStore", NDRContextHandle(), NDRContextHandle),
...
class RRPC_FWAddFirewallRule2_33_Response(NDRPacket):
    fields_desc = [
        NDRIntEnumField("pStatus", 0, FW_RULE_STATUS),
        NDRIntField("status", 0),
    ]
...
class RRPC_FWSetFirewallRule2_33_Request(NDRPacket):
    fields_desc = [
        NDRLongField("rpcConnHandle", 0),
        NDRPacketField("hPolicyStore", NDRContextHandle(), NDRContextHandle),
        NDRPacketField("pRule", PFW_RULE(), PFW_RULE),
...
class RRPC_FWSetFirewallRule2_33_Response(NDRPacket):
    fields_desc = [
        NDRIntEnumField("pStatus", 0, FW_RULE_STATUS),
        NDRIntField("status", 0),
    ]
...
class RRPC_FWEnumFirewallRules2_33_Request(NDRPacket):
    fields_desc = [
        NDRLongField("rpcConnHandle", 0),
        NDRPacketField("hPolicyStore", NDRContextHandle(), NDRContextHandle),
        NDRIntField("dwFilteredByStatus", 0),
...
class RRPC_FWEnumFirewallRules2_33_Response(NDRPacket):
    fields_desc = [
        NDRIntField("pdwNumRules", 0),
...
class RRPC_FWQueryFirewallRules2_33_Request(NDRPacket):
    fields_desc = [
        NDRLongField("rpcConnHandle", 0),
        NDRPacketField("hPolicyStore", NDRContextHandle(), NDRContextHandle),
        NDRPacketField("pQuery", PFW_QUERY(), PFW_QUERY),
...
class RRPC_FWQueryFirewallRules2_33_Response(NDRPacket):
    fields_desc = [
        NDRIntField("pdwNumRules", 0),
        NDRFullPointerField(NDRPacketField("ppRules", PFW_RULE(), PFW_RULE)),
        NDRIntField("status", 0),
...
REMOTEFW_OPNUMS = {
    ...
    90: DceRpcOp(
        RRPC_FWAddFirewallRule2_33_Request, RRPC_FWAddFirewallRule2_33_Response
    ),
    91: DceRpcOp(
        RRPC_FWSetFirewallRule2_33_Request, RRPC_FWSetFirewallRule2_33_Response
    ),
    92: DceRpcOp(
        RRPC_FWEnumFirewallRules2_33_Request, RRPC_FWEnumFirewallRules2_33_Response
    ),
    93: DceRpcOp(
        RRPC_FWQueryFirewallRules2_33_Request, RRPC_FWQueryFirewallRules2_33_Response
    ),
}
register_dcerpc_interface(
    name="RemoteFW",
