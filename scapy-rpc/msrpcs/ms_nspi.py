...
# ms-nspi.idl compiled on 10/07/2025
"""
...
class Opnum15NotUsedOnWire_Request(NDRPacket):
    fields_desc = [
        NDRPacketField("Reserved1", NDRContextHandle(), NDRContextHandle),
        NDRIntField("Reserved2", 0),
        NDRIntField("Reserved3", 0),
        NDRPacketField("Reserved4", BinaryArray_r(), BinaryArray_r),
    ]


class Opnum15NotUsedOnWire_Response(NDRPacket):
    fields_desc = [NDRIntField("status", 0)]
...
class NspiGetNamesFromIDs_Request(NDRPacket):
    fields_desc = [
        NDRPacketField("hRpc", NDRContextHandle(), NDRContextHandle),
        NDRIntField("Reserved", 0),
        NDRFullPointerField(NDRPacketField("lpguid", FlatUID_r(), FlatUID_r)),
        NDRFullPointerField(
            NDRPacketField("pPropTags", PropertyTagArray_r(), PropertyTagArray_r)
        ),
    ]
...
class NspiGetNamesFromIDs_Response(NDRPacket):
    fields_desc = [
        NDRFullPointerField(
            NDRPacketField(
                "ppReturnedPropTags", PropertyTagArray_r(), PropertyTagArray_r
            )
        ),
        NDRFullPointerField(
            NDRPacketField("ppNames", PropertyNameSet_r(), PropertyNameSet_r)
        ),
        NDRIntField("status", 0),
    ]


class NspiGetIDsFromNames_Request(NDRPacket):
    fields_desc = [
        NDRPacketField("hRpc", NDRContextHandle(), NDRContextHandle),
        NDRIntField("Reserved", 0),
        NDRIntField("dwFlags", 0),
...
class NspiGetIDsFromNames_Response(NDRPacket):
    fields_desc = [
        NDRFullPointerField(
            NDRPacketField("ppPropTags", PropertyTagArray_r(), PropertyTagArray_r)
        ),
...
NSPI_OPNUMS = {
    ...
    15: DceRpcOp(Opnum15NotUsedOnWire_Request, Opnum15NotUsedOnWire_Response),
    16: DceRpcOp(NspiQueryColumns_Request, NspiQueryColumns_Response),
    17: DceRpcOp(NspiGetNamesFromIDs_Request, NspiGetNamesFromIDs_Response),
    18: DceRpcOp(NspiGetIDsFromNames_Request, NspiGetIDsFromNames_Response),
