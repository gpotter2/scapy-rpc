...
# ms-csvp.idl compiled on 10/07/2025
"""
...
- IClusterLogEx2 (v0.0): 2510EA7D-C355-40C9-852C-E3B1B1338D67
- IClusterLogEx3 (v0.0): E6D3C166-560F-4B58-B31A-FDEA05FB606F
...
class GenerateClusterSetLog_Request(NDRPacket):
    fields_desc = [
        NDRIntField("SpanMinutes", 0),
        NDRInt3264EnumField("flags", 0, ClusterLogExFlag),
    ]
...
class GenerateClusterNetworkhLog_Request(NDRPacket):
    fields_desc = [
        NDRIntField("SpanMinutes", 0),
        NDRSignedIntField("NetworkDiagnosticsLevel", 0),
        NDRInt3264EnumField("flags", 0, ClusterLogExFlag),
    ]
...
class GenerateNetftLog_Request(NDRPacket):
    fields_desc = [
        NDRIntField("SpanMinutes", 0),
        NDRInt3264EnumField("flags", 0, ClusterLogExFlag),
    ]
...
class GenerateLogEx_Request(NDRPacket):
    fields_desc = [
        NDRInt3264EnumField("Type", 0, ClusterLogType),
        NDRIntField("SpanMinutes", 0),
        NDRInt3264EnumField("flags", 0, ClusterLogExFlag),
        NDRSignedIntField("NoCollate", 0),
    ]
...
class GetCountLogs_Request(NDRPacket):
    fields_desc = []


class GetCountLogs_Response(NDRPacket):
    fields_desc = [NDRIntField("Count", 0), NDRIntField("status", 0)]


class GetLogFilePath_Request(NDRPacket):
...
register_com_interface(
    name="IClusterLogEx2",
    uuid=uuid.UUID("2510EA7D-C355-40C9-852C-E3B1B1338D67"),
    opnums=ICLUSTERLOGEX2_OPNUMS,
)


class GenerateLogEx2_Request(NDRPacket):
    fields_desc = [
        NDRInt3264EnumField("Type", 0, ClusterLogType),
        NDRIntField("SpanMinutes", 0),
        NDRInt3264EnumField("flags", 0, ClusterLogExFlag),
