...
ICERTADMIND_OPNUMS = {  # 0: Opnum0NotUsedOnWire,
    # 1: Opnum1NotUsedOnWire,
    # 2: Opnum2NotUsedOnWire,
    3: DceRpcOp(SetExtension_Request, SetExtension_Response),
    4: DceRpcOp(SetAttributes_Request, SetAttributes_Response),
    5: DceRpcOp(ResubmitRequest_Request, ResubmitRequest_Response),
    6: DceRpcOp(DenyRequest_Request, DenyRequest_Response),
    7: DceRpcOp(IsValidCertificate_Request, IsValidCertificate_Response),
    8: DceRpcOp(PublishCRL_Request, PublishCRL_Response),
    9: DceRpcOp(GetCRL_Request, GetCRL_Response),
    10: DceRpcOp(RevokeCertificate_Request, RevokeCertificate_Response),
    11: DceRpcOp(EnumViewColumn_Request, EnumViewColumn_Response),
    12: DceRpcOp(GetViewDefaultColumnSet_Request, GetViewDefaultColumnSet_Response),
    13: DceRpcOp(
        EnumAttributesOrExtensions_Request, EnumAttributesOrExtensions_Response
    ),
    14: DceRpcOp(OpenView_Request, OpenView_Response),
    15: DceRpcOp(EnumView_Request, EnumView_Response),
    16: DceRpcOp(CloseView_Request, CloseView_Response),
    17: DceRpcOp(ServerControl_Request, ServerControl_Response),
    18: DceRpcOp(Ping_Request, Ping_Response),
    19: DceRpcOp(GetServerState_Request, GetServerState_Response),
    20: DceRpcOp(BackupPrepare_Request, BackupPrepare_Response),
    21: DceRpcOp(BackupEnd_Request, BackupEnd_Response),
    22: DceRpcOp(
        BackupGetAttachmentInformation_Request, BackupGetAttachmentInformation_Response
    ),
    23: DceRpcOp(BackupGetBackupLogs_Request, BackupGetBackupLogs_Response),
    24: DceRpcOp(BackupOpenFile_Request, BackupOpenFile_Response),
    25: DceRpcOp(BackupReadFile_Request, BackupReadFile_Response),
    26: DceRpcOp(BackupCloseFile_Request, BackupCloseFile_Response),
    27: DceRpcOp(BackupTruncateLogs_Request, BackupTruncateLogs_Response),
    28: DceRpcOp(ImportCertificate_Request, ImportCertificate_Response),
    29: DceRpcOp(BackupGetDynamicFiles_Request, BackupGetDynamicFiles_Response),
    30: DceRpcOp(
...
ICERTADMIND2_OPNUMS = {  # 0: Opnum0NotUsedOnWire,
    # 1: Opnum1NotUsedOnWire,
    # 2: Opnum2NotUsedOnWire,
    3: DceRpcOp(SetExtension_Request, SetExtension_Response),
    4: DceRpcOp(SetAttributes_Request, SetAttributes_Response),
    ...
    31: DceRpcOp(PublishCRLs_Request, PublishCRLs_Response),
    32: DceRpcOp(GetCAProperty_Request, GetCAProperty_Response),
    33: DceRpcOp(SetCAProperty_Request, SetCAProperty_Response),
    34: DceRpcOp(GetCAPropertyInfo_Request, GetCAPropertyInfo_Response),
    35: DceRpcOp(EnumViewColumnTable_Request, EnumViewColumnTable_Response),
    36: DceRpcOp(GetCASecurity_Request, GetCASecurity_Response),
    37: DceRpcOp(SetCASecurity_Request, SetCASecurity_Response),
    38: DceRpcOp(Ping2_Request, Ping2_Response),
    39: DceRpcOp(GetArchivedKey_Request, GetArchivedKey_Response),
    40: DceRpcOp(GetAuditFilter_Request, GetAuditFilter_Response),
    41: DceRpcOp(SetAuditFilter_Request, SetAuditFilter_Response),
    42: DceRpcOp(GetOfficerRights_Request, GetOfficerRights_Response),
    43: DceRpcOp(SetOfficerRights_Request, SetOfficerRights_Response),
    44: DceRpcOp(GetConfigEntry_Request, GetConfigEntry_Response),
    45: DceRpcOp(SetConfigEntry_Request, SetConfigEntry_Response),
    46: DceRpcOp(ImportKey_Request, ImportKey_Response),
    47: DceRpcOp(GetMyRoles_Request, GetMyRoles_Response),
    48: DceRpcOp(DeleteRow_Request, DeleteRow_Response),
}
register_com_interface(
    name="ICertAdminD2",
