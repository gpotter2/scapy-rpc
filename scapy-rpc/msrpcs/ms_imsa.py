...
IIISCERTOBJ_OPNUMS = {  # 0: Opnum0NotUsedOnWire,
    ...
    5: DceRpcOp(GetIDsOfNames_Request, GetIDsOfNames_Response),
    6: DceRpcOp(Invoke_Request, Invoke_Response),
    7: DceRpcOp(put_Opnum7NotUsedOnWire_Request, put_Opnum7NotUsedOnWire_Response),
    8: DceRpcOp(put_Opnum8NotUsedOnWire_Request, put_Opnum8NotUsedOnWire_Response),
    9: DceRpcOp(put_Opnum9NotUsedOnWire_Request, put_Opnum9NotUsedOnWire_Response),
    10: DceRpcOp(put_InstanceName_Request, put_InstanceName_Response),
