...
class EnumDisksEx_Response(NDRPacket):
    fields_desc = [
        ...
        NDRConfPacketListField(
            "diskList", [], diskinfoex, size_is=lambda pkt: pkt.diskCount, ptr_lvl=1
        ),
...
IVOLUMECLIENT3_OPNUMS = {  # 0: Opnum0NotUsedOnWire,
    # 1: Opnum1NotUsedOnWire,
    # 2: Opnum2NotUsedOnWire,
    3: DceRpcOp(EnumDisksEx_Request, EnumDisksEx_Response),
    4: DceRpcOp(EnumDiskRegionsEx_Request, EnumDiskRegionsEx_Response),
    ...
    9: DceRpcOp(InitializeDiskStyle_Request, InitializeDiskStyle_Response),
    ...
    27: DceRpcOp(EnumVolumes_Request, EnumVolumes_Response),
    28: DceRpcOp(EnumVolumeMembers_Request, EnumVolumeMembers_Response),
    29: DceRpcOp(CreateVolume_Request, CreateVolume_Response),
    30: DceRpcOp(
    ...
    32: DceRpcOp(GetVolumeMountName_Request, GetVolumeMountName_Response),
    33: DceRpcOp(GrowVolume_Request, GrowVolume_Response),
    34: DceRpcOp(DeleteVolume_Request, DeleteVolume_Response),
    35: DceRpcOp(CreatePartitionsForVolume_Request, CreatePartitionsForVolume_Response),
    36: DceRpcOp(DeletePartitionsForVolume_Request, DeletePartitionsForVolume_Response),
    37: DceRpcOp(GetMaxAdjustedFreeSpace_Request, GetMaxAdjustedFreeSpace_Response),
    38: DceRpcOp(AddMirror_Request, AddMirror_Response),
    39: DceRpcOp(RemoveMirror_Request, RemoveMirror_Response),
    40: DceRpcOp(SplitMirror_Request, SplitMirror_Response),
    41: DceRpcOp(InitializeDiskEx_Request, InitializeDiskEx_Response),
    42: DceRpcOp(UninitializeDisk_Request, UninitializeDisk_Response),
    43: DceRpcOp(ReConnectDisk_Request, ReConnectDisk_Response),
    44: DceRpcOp(ImportDiskGroup_Request, ImportDiskGroup_Response),
    45: DceRpcOp(DiskMergeQuery_Request, DiskMergeQuery_Response),
    46: DceRpcOp(DiskMerge_Request, DiskMerge_Response),
    ...
    50: DceRpcOp(GetEncapsulateDiskInfoEx_Request, GetEncapsulateDiskInfoEx_Response),
    51: DceRpcOp(EncapsulateDiskEx_Request, EncapsulateDiskEx_Response),
    52: DceRpcOp(
...
IVOLUMECLIENT4_OPNUMS = {  # 0: Opnum0NotUsedOnWire,
    # 1: Opnum1NotUsedOnWire,
    # 2: Opnum2NotUsedOnWire,
    3: DceRpcOp(RefreshEx_Request, RefreshEx_Response),
    4: DceRpcOp(GetVolumeDeviceName_Request, GetVolumeDeviceName_Response),
}
register_com_interface(
    name="IVolumeClient4",
