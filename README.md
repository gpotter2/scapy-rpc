...
A **Microsoft Interface Definition Language** (MIDL) compiler that generates [Scapy](https://github.com/secdev/scapy) code, to interact with [MS-RPC](https://docs.microsoft.com/en-us/windows/win32/rpc) (and DCOM) interfaces.
